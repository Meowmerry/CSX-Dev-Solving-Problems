...
create a function that take array and number
    declare init value assign to first element in array 
    declare a compare variable assign to 0 
    iterate thru the the rest of array 
        check if init value add to the current element 
            if init value is equal to target return true
...
function subsetSum(arr, target) {
    ...
    // declare the resultWithoutInit assaing to invoking subsetSum func and passed restOfArr, target
